...
const SmartTripPlanner: React.FC = () => {
  ...
  return (
    <div className="p-4 max-w-xl mx-auto bg-rose-50/50 rounded-2xl shadow-lg">
      <h2 className="text-2xl font-semibold mb-4 text-rose-900">Lịch trình thông minh</h2>
      ...
      {step === 4 && itinerary && (
        <div className="space-y-4">
          <h3 className="text-xl font-semibold mb-2 text-rose-900">Lịch trình của bạn</h3>
          {itinerary.map((day) => (
            <div key={day.day} className="border border-rose-200 p-2 rounded mb-2 bg-rose-50">
